  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Emails Sent Today" value="1,284" icon={<Send size={24} />} trend="+12% from yesterday" />
        <StatCard title="Active Mailboxes" value="8" icon={<Globe size={24} />} trend="All systems normal" />
        <StatCard title="Unread Replies" value="23" icon={<Inbox size={24} />} trend="5 high intent" alert />
        <StatCard title="Warm-up Health" value="98%" icon={<Activity size={24} />} trend="Excellent condition" success />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
        <div className="col-span-2 bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
          ...
          <div className="h-72 flex items-center justify-center text-slate-400 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl border border-dashed border-slate-200">
            ...
            <p className="font-medium text-sm">Chart Placeholder: Volume over 7 days</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex flex-col">
          ...
          <div className="space-y-4 flex-1 overflow-y-auto pr-2">
            <div className="p-4 rounded-xl bg-blue-50/50 border border-blue-100 cursor-pointer hover:bg-blue-50 hover:border-blue-200 transition-all">
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 cursor-pointer hover:bg-slate-100 transition-all">
              <div className="flex justify-between items-start mb-2">
