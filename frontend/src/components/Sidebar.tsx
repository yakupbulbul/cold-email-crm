...
import { LayoutDashboard, Globe, Send, Inbox, Activity, Server, Users, Settings, ShieldX, TrendingUp, Network, Bell, Cpu, Cable, ListChecks, MailPlus, X, ClipboardList, ShieldCheck } from 'lucide-react';
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/mcp-connector", label: "MCP Connector", icon: Cable },
