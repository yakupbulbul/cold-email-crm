...
def test_verify_domain_reports_ready_when_dns_passes(client: TestClient, auth_headers: dict, monkeypatch):
...
def test_domain_status_endpoint_returns_structured_summary(client: TestClient, auth_headers: dict):
...
def test_delete_domain_removes_local_record(client: TestClient, auth_headers: dict):
